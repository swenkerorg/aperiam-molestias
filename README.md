[![npm](https://img.shields.io/npm/v/@swenkerorg/aperiam-molestias.svg)](https://www.npmjs.com/package/@swenkerorg/aperiam-molestias) ![downloads](https://img.shields.io/npm/dt/@swenkerorg/aperiam-molestias.svg) [![CI](https://github.com/swenkerorg/aperiam-molestias/actions/workflows/ci.yml/badge.svg)](https://github.com/swenkerorg/aperiam-molestias/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@swenkerorg/aperiam-molestias/renderer](https://www.npmjs.com/package/@@swenkerorg/aperiam-molestias/renderer).

## tl;dr

- Install by executing `npm install @swenkerorg/aperiam-molestias` or `yarn add @swenkerorg/aperiam-molestias`.
- Import by adding `import { Document } from '@swenkerorg/aperiam-molestias'`.
...
[Online demo](https://projects.wojtekmaj.pl/@swenkerorg/aperiam-molestias/) is also available!
...
- [v7.x](https://github.com/swenkerorg/aperiam-molestias/blob/v7.x/packages/@swenkerorg/aperiam-molestias/README.md)
- [v6.x](https://github.com/swenkerorg/aperiam-molestias/blob/v6.x/README.md)
- [v5.x](https://github.com/swenkerorg/aperiam-molestias/blob/v5.x/README.md)
- [v4.x](https://github.com/swenkerorg/aperiam-molestias/blob/v4.x/README.md)
- [v3.x](https://github.com/swenkerorg/aperiam-molestias/blob/v3.x/README.md)
- [v2.x](https://github.com/swenkerorg/aperiam-molestias/blob/v2.x/README.md)
- [v1.x](https://github.com/swenkerorg/aperiam-molestias/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @swenkerorg/aperiam-molestias` or `yarn add @swenkerorg/aperiam-molestias`.
...
```ts
import { pdfjs } from '@swenkerorg/aperiam-molestias';
...
import { Document, Page } from '@swenkerorg/aperiam-molestias';
...
Check the [sample directory](https://github.com/swenkerorg/aperiam-molestias/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/swenkerorg/aperiam-molestias/wiki/Recipes) in [React-PDF Wiki](https://github.com/swenkerorg/aperiam-molestias/wiki/).
...
```ts
import '@swenkerorg/aperiam-molestias/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@swenkerorg/aperiam-molestias/dist/Page/TextLayer.css';
```
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@swenkerorg/aperiam-molestias__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@swenkerorg/aperiam-molestias__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@swenkerorg/aperiam-molestias__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@swenkerorg/aperiam-molestias__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/swenkerorg/aperiam-molestias/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@swenkerorg/aperiam-molestias-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@swenkerorg/aperiam-molestias-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@swenkerorg/aperiam-molestias-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@swenkerorg/aperiam-molestias-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@swenkerorg/aperiam-molestias-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@swenkerorg/aperiam-molestias-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@swenkerorg/aperiam-molestias/contributors.svg?width=890&button=false)
